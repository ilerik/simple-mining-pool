...
SYSTEM_URL=http://127.0.0.1:8200/api/system/v1
EXPLORER_URL=http://127.0.0.1:8200/api/explorer/v1

# Base URL for simple-mining-pool service endpoints
BASE_URL=http://127.0.0.1:8200/api/services/simple_mining_pool/v1
